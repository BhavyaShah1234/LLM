...
def build_arg_parser() -> argparse.ArgumentParser:
    """Build the CLI parser for this script's model/LoRA/DPO/training options.

    Returns:
        argparse.ArgumentParser: Parser covering model/quantization, LoRA,
        DPO (`--beta`, `--max_length`), training hyperparameters, data
...
def main():
    """Run the DPO alignment pipeline: load data, build the trainer, train, evaluate, save, and record results."""
